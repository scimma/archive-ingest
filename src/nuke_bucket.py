...
delete_all_versions("hopprod-scimma-housekeeping", None) # empties the entire bucket
delete_all_versions("hopprod-scimma-housekeeping-backup", None) # empties the entire bucket
